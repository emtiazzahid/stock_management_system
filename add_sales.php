...
<head>
    <meta charset="utf-8">
    <title>SDK - Add Stock Category</title>
            ...
            <div class="content-module">
                ...
                <div class="content-module-main cf">
                        ...
                        if ($validated_data === false) {
                            ...
                            for ($i = 0; $i < count($stock_name); $i++) {
                                ...
                                if ($count >= 1) {
                                    ...
                                    $db->query("insert into stock_sales (discount,dis_amount,grand_total,transactionid,stock_name,selling_price,quantity,amount,date,username,customer_id,subtotal,payment,balance,due,mode,description,count1,billnumber)
                            values('$discount','$dis_amount','$payable','$autoid','$name1','$rate','$quantity','$total','$mysqldate','$username','$customer','$subtotal','$payment','$balance','$due','$mode','$description',$i+1,'$bill_no')");
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <p><strong>Add Stock/Product </strong></p>
